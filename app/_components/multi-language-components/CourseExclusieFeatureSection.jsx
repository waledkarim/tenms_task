                ...
                data && data.values &&
                        <div>
                            ...
                            <div class="flex flex-col gap-3 mb-10">
                                ...
                                <div class="grid grid-cols-1 px-5 border divide-y rounded-md ">

                                    {
                                        data.values.map((item, ind) => (

                                            <div key={ind} class="flex flex-col items-start justify-between gap-3 py-5 md:flex-row">

                                                <div class="flex flex-col gap-2">

                                                    <h2 class="text-[14px] font-[500px] leading-[30px] text-[#111827] md:text-[16px]">{item.title}</h2>

                                                    {
                                                        item.checklist.map((text, ind) => (

                                                            <div key={ind} class="flex flex-row items-center gap-5">
                                                                ...
                                                                <p class="text-[14px] font-[400px] leading-[24px] text-[#4B5563] md:text-[16px]">{text}</p>
                                                ...
                                                <div>
                                                    <div class="mb-4 mx-auto max-w-[350px]">
