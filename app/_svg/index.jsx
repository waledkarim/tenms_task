...
export function SmallPlayBtnSVG({ extraDesign }){
    return(
        <img className={`${extraDesign}`} name="Play The Video" alt="Play The Video" data-original-src="/images/annual_exam/play_icon_2.svg" fetchpriority="high" width="20" height="20" decoding="async" data-nimg="1" style={{color: "transparent"}} src="https://10minuteschool.com/images/annual_exam/play_icon_2.svg"></img>
    );
}